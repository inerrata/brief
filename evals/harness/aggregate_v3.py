#!/usr/bin/env python3
"""Aggregate v3 grading into benchmarks/benchmark-v3-newfeatures.json + a
...
OUT_JSON = HERE.parent.parent / "benchmarks" / "benchmark-v3-newfeatures.json"
...
def main():
    ...
    result = {"set": "evals-v3.json", "runs_per_arm": 1,
