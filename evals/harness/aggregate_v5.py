#!/usr/bin/env python3
"""Aggregate v3 grading into benchmarks/benchmark-v5-localization-compliance.json + a
...
V3 = HERE.parent / "results" / "v5"
OUT_JSON = HERE.parent.parent / "benchmarks" / "benchmark-v5-localization-compliance.json"
...
def main():
    ...
    result = {"set": "evals-v5.json", "runs_per_arm": 1,
